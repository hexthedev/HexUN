...
namespace HexUN.MonoB
{
    ...
    public abstract class AMonoSingletonScene<T> : AQuitter where T : AMonoSingletonScene<T>
    {
        ...
        public static T Instance
        {
            get
            {
                if (AppQuitting)
                {
                    Debug.LogWarning($"No {nameof(AMonoSingletonScene<T>)} returned because application is quiting");
                    return null;
                }
